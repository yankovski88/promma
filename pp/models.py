...
class PpClass (models.Model):
    class Meta ():
        db_table = 'pp_class' # теперь мы будем знать к чему относиться наша модель или ее название
    '''
    наша стандартная модель
    '''
    pp_title = models.CharField (max_length=200, verbose_name= 'Заголовок', blank=True,)
    pp_text = models.TextField (verbose_name='текст', blank=True, )
